...
add_action( 'wp_enqueue_scripts', function () {
    ...
    if (is_post_type_archive('project')) {
        wp_enqueue_script( 'offers-script', get_template_directory_uri() . '/dist/projects.js', ['jquery-cdn'], filemtime( get_stylesheet_directory() . '/dist/projects.js' ), true );
    }
    if (is_singular('project')) {
        ...
        wp_enqueue_script( 'offers-script', get_template_directory_uri() . '/dist/projectDetail.js', ['jquery-cdn', 'before-after-slider'], filemtime( get_stylesheet_directory() . '/dist/projectDetail.js' ), true );
//        $before_after_slider_data = [
//            'before' => the_field( 'before-after-slider-before-image' ),
//            'after'  => the_field( 'before-after-slider-before-image' ),
//        ];
//        wp_localize_script('offers-script', 'sliderData', $before_after_slider_data);
    }
} );
